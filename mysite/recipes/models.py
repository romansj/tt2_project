...
class Post(models.Model):
    ...
    category_new = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, blank=True,
                                     related_name="category_posts")  # dzesot kategoriju, post taja bridi nebus kategorija, bet post lai paliek
